...
assert mode in {'component-palm-sweeps', 'component-palm-blocked'}
...
metrics = {'source_model': 'Unitree_FTP_donor_exact_E2_equivalence_unverified',
           ...
           'support_constraints': ['fixed_wrist_bench_root'], 'wrist_motion_qualification': 'NOT_RUN',
...
out.joinpath('probe.json').write_text(json.dumps({'status': 'PASS' if all(checks.values()) else 'FAIL',
                                                'scope': 'provisional_palm_collision_candidate_fixed_wrist_bench',
