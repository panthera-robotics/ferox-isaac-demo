...
elif COLLISION_POLICY['kind'] in ('public_stl_meshes', 'e2_r4_folded_slabs', 'e2_r5_folded_slabs'):   # both import the URDF as delivered (r4 bakes the representation into it)
